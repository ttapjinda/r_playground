...
##' or
##'   Rscript myfile.R --args myarg=something myboolean=T mynumeric=1
##'
##' Then in R do
##'   myargs <- getArgs()
...
##' myfile.R
##'   source("get_args.R")
##'   if (!is.null(args$myarg)) {
##'     myarg <- as.character(args$myarg)
##'   }
##'   if (!is.null(args$myboolean)) {
##'     my.boolean <- as.logical(args$myboolean)
##'   }
##'   if (!is.null(args$mynumeric)) {
##'     my.numeric <- as.numeric(args$mynumeric)
##'   }
##'
##' @title getArgs
